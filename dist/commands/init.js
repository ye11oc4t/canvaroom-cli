...
export async function cmdInit(projectName) {
    ...
    try {
        execSync(`npx create-next-app@latest ${name} --typescript --tailwind --eslint --app --no-src-dir --import-alias "@/*" --yes`, { stdio: 'pipe' });
